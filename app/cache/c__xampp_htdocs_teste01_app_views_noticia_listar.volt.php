								...
								<table id="lista-noticia" class="table dataTable table-hover">
									...
									<tbody>
										...
										<tr>
                                            ...
                                            <td class="titulo"><?= $noticia->getTitle() ?></td>
                                            <td class="text-center"><?= $noticia->getText() ?></td>
                                            <td>
                                                <a href="<?= $this->url->get(['for' => 'noticia.editar', 'id' => $noticia->getId()]) ?>"><span class="glyphicon glyphicon-pencil"></span></a>
