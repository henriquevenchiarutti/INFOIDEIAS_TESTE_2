                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="form-group col-sm-12">
                                                <p><strong>Data de Criação:</strong> <?= $noticia->getRegisterDate() ?> </p>
                                                <p><strong>Data da Última Atualização:</strong> <?= $noticia->getLastUpdateDate() ?> </p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-sm-12">
                                                <label for ="Titulo">Título <span class="error">(*)<span></label>
                                                <?= $this->tag->textField(['titulo', 'width' => '100%', 'class' => 'form-control', 'required' => 'required', 'value' => $noticia->getTitle()]) ?>                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-sm-12">
                                                <label for ="Texto">Texto</label>
                                                <?= $this->tag->textArea(['texto', 'class' => 'form-control tinymce-editor', 'value' => $noticia->getText()]) ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
