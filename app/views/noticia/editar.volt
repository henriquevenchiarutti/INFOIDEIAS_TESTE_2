                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-sm-12">
                                                ...
                                                {{ text_field("titulo", "width": '100%', "class": 'form-control', 'required':'required', 'value': noticia.getTitle()) }}                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-sm-12">
                                                <label for ="Texto">Texto</label>
                                                {{ text_area("texto", "class": 'form-control tinymce-editor', 'value': noticia.getText()) }}
                                            </div>
                                        </div>
                                    </div>{#/.panel-body#}
                                </div>{#/.panel#}
